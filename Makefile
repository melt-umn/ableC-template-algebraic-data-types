...
EXT_NAME=ableC-template-algebraic-data-types
EXT_GRAMMAR=edu:umn:cs:melt:exts:ableC:templateAlgebraicDataTypes
EXT_DEPS=ableC-algebraic-data-types ableC-string ableC-allocation ableC-templating ableC-constructor ableC-template-constructor
USE_CUSTOM_SILVER=1
